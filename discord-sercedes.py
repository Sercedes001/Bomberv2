...
TOKEN = "MTA2MzE2OTg2Nzg0MDI0MTg0NQ.G23pyg._ALOHuRoGn4EBxrK6w1HylmJJyOgEMDHHlxHFM"
gif = "https://media.tenor.com/-g-Um3DDvV0AAAAM/explosion.gif"
adet = 50
saniye = 0
...
@client.event
async def on_ready():
    print ("Made By Sercedes")
    print('{} Çalışmaya Başladı!'.format(client.user))
    activity = discord.Activity(type=discord.ActivityType.playing, name="MADE BY SERCEDES ")
